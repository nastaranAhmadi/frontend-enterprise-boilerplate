...
export const DATE_RANGE_PICKER_PANEL_CLASS =
  'absolute start-0 top-[calc(100%+0.25rem)] z-dropdown flex w-full min-w-[17.5rem] flex-col overflow-hidden rounded-md border border-border bg-surface-elevated shadow-md sm:min-w-[36rem] sm:flex-row';
