...
export const CALENDAR_WEEKDAY_CELL_CLASS =
  'pb-xs text-center text-xs font-medium text-muted sm:text-sm';
...
export const CALENDAR_DAY_OUTSIDE_CLASS = 'text-muted/60';

export const CALENDAR_DAY_TODAY_CLASS = 'font-semibold text-primary';

export const CALENDAR_DAY_SELECTED_CLASS = 'bg-primary text-background hover:bg-primary';
...
export const CALENDAR_DAY_RANGE_START_CLASS =
  'rounded-e-none bg-primary text-background hover:bg-primary';

export const CALENDAR_DAY_RANGE_END_CLASS =
  'rounded-s-none bg-primary text-background hover:bg-primary';
