...
export const BOTTOM_SHEET_BACKDROP_SCRIM_CLASS = 'absolute inset-0 bg-foreground/40';
...
export const BOTTOM_SHEET_PANEL_BASE_CLASS =
  'relative z-10 flex w-full flex-col overflow-hidden rounded-t-lg border border-border bg-background shadow-lg';
...
export const BOTTOM_SHEET_DESCRIPTION_CLASS = 'font-sans text-sm text-muted';
