...
export const MODAL_BACKDROP_SCRIM_CLASS = 'absolute inset-0 bg-overlay';
...
export const MODAL_PANEL_BASE_CLASS =
  'relative z-10 flex max-h-[calc(100vh-2rem)] w-full flex-col overflow-hidden rounded-md border border-border bg-surface-elevated shadow-lg';
...
export const MODAL_DESCRIPTION_CLASS = 'font-sans text-sm text-muted-foreground';
